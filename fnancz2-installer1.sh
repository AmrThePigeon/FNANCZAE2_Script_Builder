...
gamezip=$(ls -v -r 'FNANCZ_2 v*.zip'* | head -n 1)
...
wget https://raw.githubusercontent.com/AmrThePigeon/FNANCZAE2_Script_Builder/refs/heads/main/libNekoPresence_x64_linux_arm64-v8a.so
